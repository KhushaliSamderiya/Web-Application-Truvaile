...
@WebServlet("/ViewPackageQueries")
public class ViewPackageQueries extends HttpServlet {
	private static final long serialVersionUID = 1L;
       protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	           ...
	           {  
	               ...
	               ResultSet rs = (ResultSet) stmt.executeQuery("select * from Package_Queries"); 
	               out.print("<!DOCTYPE html>\r\n"
	               		...
	               		+ "    <title> Package Queries | Truvaile</title>\r\n"
	             		...
	             		+ "                        <li class=\"list-item-inline\">\r\n"
	              		...
	              		+ "                        </li>\r\n"
	              		+ "                        <li class=\"list-item-inline\">\r\n"
	                    + "                        <a class=\"link link-active\" href=\"ViewPackageQueries\">Package Queries</a>\r\n"
	                    + "                        </li>\r\n"
	               		+ "                        <li class=\"list-item-inline\">\r\n"
	               ...
	               out.println("<thead><tr><th>UserName</th><th>Booking ID</th><th>Query option</th><th>Reason</th></tr><thead>");  
	               while (rs.next()) 
	               {  
	                     String uname = rs.getString("User_name");
	            	     Long Id = rs.getLong("Bookind_id");
		            	 String query = rs.getString("Query_option");
		            	 String msg = rs.getString("Reason");
		            
	                  
	                   out.println("<tbody><tr><td>" + uname + "</td><td>" + Id + "</td><td>" +query + "</td><td>" + msg + "</td></tr></tbody>");   
	               }  
